	...
	<div class="container-fluid" style="background-color: #97a1a8;">
		...
		<section id="formulario">
			<div class="container">
				...
				<form method="POST" action="processafornecedores.php"> 
					<!-- formatar mascaras -->
					...
					<div class="col-md-12">
						<h1>Fornecedores</h1>
						<p>Preencha os campos abaixo para o cadastro de fornecedores.</p>
					</div>
					<div class="row">
						<!-- dados pessoais -->
						<div class="col-md-6">
                            ...
                            <div class="form-group">
								<label>CNPJ</label>
								<input type="text" name="cnpj" value="" class="form-control" id="cnpj" required>
							</div>
			...
			<fieldset>
             <legend>
              <table>
                 <tr>
                    <td><h4>Gerenciar Fornecedores</h4></a></td>
                 </tr>
              </table>
             </legend>
             <article>
