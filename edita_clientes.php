...
<body style="background-color: #97a1a8;">
  ...
  <section id="formulario">
  	<div class="container">
  		...
  		<form action="edcliente_envia.php" method="post" name="form" id="form" onSubmit="return valida_dados(this)">
	...
	<div class="col-md-6">
		...
		<!-- div campos obrigatórios -->	
			...
			<input type="reset" class="btn" name="cancelar" value="Cancelar" class="botao" onclick="javascript: location.href='cliente.php';" style="background-color: #091b29; color:#97a1a8; ">
